  ...
  return id ? (
    <div>
      ...
      {!isOpen && (
        ...
        >
          <span className="text-sm w-fit">OBRIGADO POR PARTICIPAR DO EVENTO</span>
          <Heart />
        </button>
      )}
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div ref={modalRef} className="bg-white rounded-lg shadow-xl p-6 max-w-lg mx-4 w-full relative">
            ...
            >
              <h2 className="text-3xl font-bold uppercase tracking-wide mb-4 text-teal-600">PARABÉNS!</h2>
              ...
              {finalCode && (
                <div className="bg-zinc-900 text-white px-4 py-2 rounded-lg text-sm break-all">
